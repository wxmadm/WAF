...
from dataloaders.dataset_DDTI import BaseDataSets, RandomGenerator_Strong_Weak
...
parser.add_argument('--root_path', type=str,
                    default='/home/wxm/code/SSLM4-LIS/data/DDTI/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='DDTI/Fix-match-dwt-SE-SA', help='experiment_name')
parser.add_argument('--labeled', type=int,
                    default='200', help='model_name')
