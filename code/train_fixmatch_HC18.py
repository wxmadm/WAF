...
from dataloaders.dataset_HC18 import BaseDataSets, RandomGenerator_Strong_Weak
...
parser.add_argument('--root_path', type=str,
                    default='/home/wxm/code/SSLM4-LIS/data/HC18/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='HC18/Fix-match-dwt-SE', help='experiment_name')
