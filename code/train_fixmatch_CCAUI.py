...
from dataloaders.dataset_CCAUI import BaseDataSets, RandomGenerator_Strong_Weak
...
parser.add_argument('--root_path', type=str,
                    default='/home/wxm/code/SSLM4-LIS/data/CCAUI/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='CCAUI/Fix-match-dwt-SE-SA', help='experiment_name')
parser.add_argument('--labeled', type=int,
                    default='10', help='model_name')
parser.add_argument('--model', type=str,
                    default='unet', help='model_name')
parser.add_argument('--labeled_ratio', type=int, default=8,
                    help='1/labeled_ratio data is provided mask')
parser.add_argument('--fold', type=int,
                    default=3, help='cross validation')#交叉验证的折数，指定当前实验使用第几折数据，
parser.add_argument('--cross_val', type=bool,  #表示会使用五折交叉验证
...
parser.add_argument('--labeled-id-path', default='/home/data/lwb/semi-supervised/SSLM4-LIS/code/spilt/PSFHS/100/labeled.txt',type=str)#, required=True)
parser.add_argument('--unlabeled-id-path',default='/home/data/lwb/semi-supervised/SSLM4-LIS/code/spilt/PSFHS/100/unlabeled.txt', type=str)#, required=True)
...
def train(args, snapshot_path):
    ...
    def create_model(ema=False):
        # Network definition
        model = net_factory(net_type=args.model, in_chns=4,
    ...
    trainloader_labeled = DataLoader(
        db_train_labeled, batch_size=args.batch_size//2, shuffle=True,num_workers=8)
    trainloader_unlabeled = DataLoader(
        db_train_unlabeled, batch_size=args.batch_size//2, shuffle=True,num_workers=8)
...
if __name__ == "__main__":
    ...
    snapshot_path = "/home/wxm/code/model/{}/{}/{}".format(
            args.labeled,args.exp, args.model)
