...
parser.add_argument('--root_path', type=str,
                    default='/home/wxm/code/SSLM4-LIS/data/CCAUI/test',
                    help='Path to test data folder')
parser.add_argument('--exp', type=str,
                    default='HC18/Fix-match-oriwavlet-Yls/5', help='experiment_name')
...
parser.add_argument('--pred_save_path', type=str, default='/home/wxm/code/SSLM4-LIS/result/CCAUI/10/Fix-match-dwt-SE-SA', help='Path to save predicted labels as PNG')
parser.add_argument('--save_mode_path', type=str, default='/home/wxm/code/model/10/CCAUI/Fix-match-dwt-SE-SA/unet/unet_best_model.pth', help='Path to save predicted labels as PNG')
