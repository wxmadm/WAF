...
parser.add_argument('--root_path', type=str,
                    default='/home/wxm/code/SSLM4-LIS/data/HC18/test',
...
parser.add_argument('--pred_save_path', type=str, default='/home/wxm/code/SSLM4-LIS/result/HC18/10/Fix-match-dwt-SE', help='Path to save predicted labels as PNG')
parser.add_argument('--save_mode_path', type=str, default='/home/wxm/code/model/10/HC18/Fix-match-dwt-SE/unet/unet_best_model.pth', help='Path to save predicted labels as PNG')
