...
class BaseDataSets(Dataset):
    def __init__(self, base_dir=None, labeled_type="labeled", labeled_ratio=10, split='train', transform=None, fold=1, cross_val=True):
        ...
        train_files = set(os.listdir("/home/wxm/code/SSLM4-LIS/data/DDTI/train"))
        val_files = set(os.listdir("/home/wxm/code/SSLM4-LIS/data/DDTI/val"))
        print("Train-Val Overlap:", train_files.intersection(val_files))
        if self.split == 'train':
            self.all_slices = os.listdir("/home/wxm/code/SSLM4-LIS/data/DDTI/train_val")#去加载 他的切片，这个切片数据包含很多 ，所有train的 切片，有标签和无标签都包含进去
            self.sample_list = []
            labeled_ids = sorted(os.listdir(self._base_dir + "50/labeled"))
            unlabeled_ids = sorted(os.listdir(self._base_dir + "50/unlabeled"))
            ...
            # 加载所有的切片数据
            self.all_slices = os.listdir("/home/wxm/code/SSLM4-LIS/data/DDTI/train_val")
